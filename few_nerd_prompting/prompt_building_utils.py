...
def make_output_example(sentence, labels, entity_class):
    sentence_list = []
...
def output_well_formed(sentence):
...
def build_llama2_prompt(few_shot_examples, system_msg, input_example):
...
def build_llama2_prompt_plain(few_shot_examples, system_msg, input_example):
...
def build_self_verification_prompt_plain(system_msg, input_example, candidate_entity, entity_class):
